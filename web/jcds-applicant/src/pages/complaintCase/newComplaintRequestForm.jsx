              ...
              <div className="flex flex-col">
                ...
                <div className="relative w-full max-w-[clamp(280px,16.67vw,320px)]">
                  <select
                    ...
                    className={`w-full h-[clamp(44px,4.07vh,48px)] rounded-md pl-[clamp(16px,0.83vw,16px)] pr-[clamp(40px,2.08vw,40px)] font-['Montserrat'] font-normal text-[clamp(12px,0.73vw,14px)] leading-none tracking-normal outline-none appearance-none cursor-pointer ${formErrors.caseType ? "border-red-500" : ""} text-[#393838] ${loadingCaseTypes ? "opacity-50 cursor-not-allowed" : ""}`}
                    style={{ 
                      fontFamily: "'Montserrat', sans-serif",
                      background: '#F9F9F9',
