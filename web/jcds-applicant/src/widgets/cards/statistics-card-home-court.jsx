...
export function StatisticsCardHomeCourt({
  request_type,
              ...
              <div className="flex flex-col gap-1">
                <div className="flex items-center gap-1">
                  ...
                  >
                    ...
                    {" - "}
                    <span className="font-medium text-[10px] text-blue-500">( court )</span>
                  </Typography>
...
StatisticsCardHomeCourt.defaultProps = {
...
StatisticsCardHomeCourt.propTypes = {
...
export default StatisticsCardHomeCourt;
