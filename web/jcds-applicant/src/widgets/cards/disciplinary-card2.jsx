...
export function DisciplinaryCard2({
  request_id,
  applicantName,
  status,
  judge_name,
  ...
  const handleViewDetails = () => {
    ...
    setTimeout(() => {
      ...
      navigate(`/home/disciplinary-details-v2/${shortId}`, {
  ...
  const handleEditRequest = () => {
    ...
    setTimeout(() => {
      ...
      navigate(`/home/edit-disciplinary-request-v2/${shortId}`, {
        state: { fullRequestId: request_id },
      });
      stopLoading();
    }, 100);
        ...
        <div className="flex flex-col md:flex-row h-full">
          ...
          <div className="bg-white w-full md:w-[72%] flex flex-col p-4 sm:p-6">
            <div className="flex-grow">
              ...
              {/* Court Office and Documents Row */}
              <div className="grid grid-cols-2 gap-4 mb-4">
                <div>
                  <Typography
                    variant="small"
            ...
            {/* Footer with Request Date and View Button */}
...
DisciplinaryCard2.defaultProps = {
  status: "pending",
  judge_name: "N/A",
  court_office: "N/A",
  file_number: "N/A",
...
export default DisciplinaryCard2;
