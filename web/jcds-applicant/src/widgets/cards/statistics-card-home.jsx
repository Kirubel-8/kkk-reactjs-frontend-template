...
export function StatisticsCardHome({
  icon,
  archives,
  applicantName,
  applicantRegions,
  ...
  return (
    <>
      <Card className="h-80 rounded-lg shadow-md p-2">
...
StatisticsCardHome.defaultProps = {
...
export default StatisticsCardHome;
