...
export function StatisticsCardRespHomeHopr({
  request_type,
                      ...
                      <div className="">
                        ...
                        >
                          {hoprRequest.law_enactment_date?.length > 20
                            ? `${hoprRequest.law_enactment_date.slice(
                                0,
                                20
                              )}...`
                            : hoprRequest.law_enactment_date}
                      ...
                      <div className="">
                        ...
                        >
                          {hoprRequest.deciding_authority?.length > 20
                            ? `${hoprRequest.deciding_authority.slice(
                                0,
                                20
                              )}...`
                            : hoprRequest.deciding_authority}
...
StatisticsCardRespHomeHopr.defaultProps = {
...
StatisticsCardRespHomeHopr.propTypes = {
...
export default StatisticsCardRespHomeHopr;
