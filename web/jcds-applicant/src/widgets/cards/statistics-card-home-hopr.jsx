...
export function StatisticsCardHomeHopr({
  request_type,
        ...
        <div className="flex px-4 flex-col gap-2 pt-4">
          <div className="flex flex-wrap items-center  justify-between">
              ...
              <div className="flex flex-col gap-1">
                <div>
                  ...
                  >
                    ...
                    <span className="font-medium text-[10px] text-blue-500">( hopr )</span>
                  </Typography>
                ...
                <div>
                  ...
                  <div className="relative group ">
                    ...
                    >
                      {hoprRequest.submitting_entity?.length > 10
                        ? `${hoprRequest.submitting_entity.slice(0, 10)}...`
                        : hoprRequest.submitting_entity}
                    </Typography>
            ...
            <div className="items-center">
              ...
              <div className="relative group">
                <div
                  className={`text-center px-1 rounded-md ${status === "Approved"
                    ? "bg-green-100"
                    : status === "Pending"
                      ? "bg-yellow-100"
                      : status === "Under Review"
                ...
                >
                  <Typography
                    variant="small"
                    color="blue-gray"
                    className={`font-medium text-xs ${status === "Approved"
                      ? "text-green-800"
                      : status === "Pending"
                        ? "text-yellow-800"
                        : status === "Under Review"
                    ...
                    {archives && archives.length > 0 ? (
                      archives.map((archive, index) => (
                        ...
                        >
                          ...
                          <Typography
                            variant="small"
                            className={`font-semibold text-xs px-2 py-0.5 rounded ${archive.caseCustomerStatus === "Under Review"
              ...
              <div className="flex justify-start items-center">
                <div className="flex flex-col gap-2 w-4/6">
                  ...
                  <div>
                    ...
                    >
                      {hoprRequest.reference_number?.length > 20
                        ? `${hoprRequest.reference_number.slice(0, 20)}...`
                        : hoprRequest.reference_number}
                    </Typography>
                  </div>
                  <div>
                    {hoprRequest.submission_date && (
                      <div className="">
                        <Typography
                          variant="small"
                        ...
                        >
                          {hoprRequest.submission_date?.length > 20
                            ? `${hoprRequest.submission_date.slice(0, 20)}...`
                            : hoprRequest.submission_date}
                        </Typography>
                      </div>
                    )}
                ...
                <div className="flex flex-col gap-2 w-2/6">
                  ...
                  <div>
                    {hoprRequest.law_title && (
                      <div className="flex flex-col">
                        ...
                        >
                          {hoprRequest.law_title?.length > 20
                            ? `${hoprRequest.law_title.slice(0, 20)}...`
                            : hoprRequest.law_title}
                        </Typography>
                      </div>
                    )}
                  ...
                  <div>
                    {hoprRequest.law_enactment_date && (
                      <div className="">
                        <Typography
                          variant="small"
                          className="text-[11px] font-medium text-blue-gray-600"
                        >
                          {t("home.lawEnactmentDate")}
                        </Typography>
                        <Typography
                          variant="small"
                          color="blue-gray"
                          className="font-semibold text-[14px] truncate"
                        >
                          {hoprRequest.law_enactment_date?.length > 20
                            ? `${hoprRequest.law_enactment_date.slice(0, 20)}...`
                            : hoprRequest.law_enactment_date}
                        </Typography>
                      </div>
                    )}
          ...
          <div className="">
            <div className="flex flex-col space-y-1">
              <div className="flex justify-between items-center">
                <div className="flex flex-col gap-2 w-4/6">
                  <div>
                    {hoprRequest.deciding_authority && (
                      <div className="">
                        <Typography
                          variant="small"
                          className="text-[11px] font-medium text-blue-gray-600"
                        >
                          {t("home.decisionMakingBody")}
                        </Typography>
                        <Typography
                          variant="small"
                          color="blue-gray"
                          className="font-semibold text-[14px] truncate"
                        >
                          {hoprRequest.deciding_authority?.length > 20
                            ? `${hoprRequest.deciding_authority.slice(0, 20)}...`
                            : hoprRequest.deciding_authority}
                        </Typography>
                      </div>
                    )}
                    ...
                    {hoprRequest.decision_date && (
                      <div className=" flex flex-col gap-0">
                        <div className="group relative inline-block">
                          ...
                          >
                            {t("home.decisionDate").length > 10
                              ? `${t("home.decisionDate").slice(0, 5)}...${t(
                                "home.decisionDate"
                              ).slice(10)}`
                              : t("home.decisionDate")}
                          </Typography>
                        ...
                        <div className="relative group inline-block max-w-[80px]">
                          <Typography
                            ...
                            className="font-semibold text-[14px] truncate"
                          >
                            {hoprRequest.decision_date?.length > 20
                              ? `${hoprRequest.decision_date?.slice(0, 20)}...`
                              : hoprRequest.decision_date}
                          </Typography>
                          <div className="absolute z-10 hidden group-hover:block bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-2 py-1 bg-gray-800 text-white text-xs rounded whitespace-nowrap">
                            {hoprRequest.decision_date}
                ...
                <div className="flex flex-col gap-2 ">
                  ...
                  >
                    ...
                    >
                      ...
                      <NavLink
                        onClick={() =>
                          handleShowMoreNavigation("/home/request-detail", request_id)
                        }
                      >
                        <div className="cursor-pointer flex justify-between items-center px-3 py-1 rounded-full bg-[#4475F2]">
                          <Typography
                            variant="small"
                            color="blue-gray"
                            className="font-medium text-xs text-white"
                      ...
                      {(status === "Pending" || status === "Rejected") && (
                        <NavLink
                          onClick={() =>
                            handleEditNavigation("/home/edit-request", request_id)
                          }
                        >
                          <div className="cursor-pointer flex justify-between items-center px-3 py-1 rounded-full bg-[#FBD811]">
                            <Typography
                              variant="small"
                              color="blue-gray"
                              className="font-medium text-xs text-white"
                      ...
                      {customerDecisions && status === "Decided" && (
                        <NavLink
                          to={{ pathname: "/home/case-decision" }}
                          state={request_id}
                        >
                          <div className="cursor-pointer flex justify-between items-center px-3 py-1 rounded-full bg-[#03AD00]">
                            <Typography
                              variant="small"
                              color="blue-gray"
                              className="font-medium text-xs text-white"
...
StatisticsCardHomeHopr.defaultProps = {
...
StatisticsCardHomeHopr.propTypes = {
...
export default StatisticsCardHomeHopr;
